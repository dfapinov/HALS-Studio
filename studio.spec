...
for folder in ('process_engine', 'misc'):
...
a = Analysis([str(root/'entry.py')], pathex=[str(root), str(root/'_vendor'), str(root/'process_engine'), str(root/'misc')],
