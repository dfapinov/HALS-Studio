...
This document outlines the three supplementary Python scripts located in the `misc/` directory. These tools provide supplementary capabilities for the main pipeline, including acoustic simulation, grid stability analysis, and educational visualization.
